...
public class HotelStaffOrderViewController {
	...
	public void handleUndo() {
		// this.orderList =
		// this.orderList.getHotelUndoOrderList(this.hotelStaff.getHotelId());
		// int count=0;
		// while(count<this.orderList.size()){
		// this.orderData.add(this.orderList.get(count));
		// }
	...
	public void handleDone() {
		// this.orderList =
		// this.orderList.getHotelDoneOrderList(this.hotelStaff.getHotelId());
		// int count=0;
		// while(count<this.orderList.size()){
		// this.orderData.add(this.orderList.get(count));
		// }
	...
	public void handleException() {
		// this.orderList =
		// this.orderList.getHotelAbnormalOrderList(this.hotelStaff.getHotelId());
		// int count=0;
		// while(count<this.orderList.size()){
		// this.orderData.add(this.orderList.get(count));
		// }
